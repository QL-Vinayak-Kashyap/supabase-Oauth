...
const Process = () => {
  ...
  return (
    ...
    //       <div className="inline-block rounded-full bg-grey-100 px-3 py-1 text-sm font-medium text-grey-700 mb-4">
    //         Simple Process
    //       </div>
    ...
    //         <div className="w-20 h-20 rounded-full bg-grey-200 flex items-center justify-center mb-6">
    //           <FileText className="h-10 w-10 text-grey-700" />
    //         </div>
    ...
    //         <div className="absolute left-0 top-10 w-full h-0.5 bg-grey-100 hidden md:block -z-10"></div>
    //         <div className="w-20 h-20 rounded-full bg-grey-200 flex items-center justify-center mb-6">
    //           <Edit className="h-10 w-10 text-grey-700" />
    //         </div>
    ...
    //         <div className="absolute left-0 top-10 w-full h-0.5 bg-grey-100 hidden md:block -z-10"></div>
    //         <div className="w-20 h-20 rounded-full bg-grey-200 flex items-center justify-center mb-6">
    //           <CheckCircle className="h-10 w-10 text-grey-700" />
    //         </div>
